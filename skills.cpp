...
bool Skills::inputdata()
{
	...
	cout << "\t***Калькулятор для игры \"Крысы Онлайн\"***" << endl;
	cout << endl;
	...
	if(fout.is_open())
	{
		...
		Skills::show_four();
		Skills::show_four_discount();
	
		Skills::show_alternative();
		Skills::show_alternative_discount();
